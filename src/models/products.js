...
module.exports = {
  creteProducts: async (data = {}, tables = table) => {
    query = `INSERT INTO ${tables} SET ?`;
    return await connectToDB(query, data);
  },
  updateProducts: async (data = {}, whereData = {}, tables = table) => {
  ...
  deleteProduct: async (whereData = {}, tables = table) => {
    const { dataArr, prepStatement } = queryGenerator({ data: whereData });
  ...
  getProduct: async (whereData = {}, tables = table) => {
    const { dataArr, prepStatement } = queryGenerator({ data: whereData });
