...
module.exports = {
  creteRoles: async (data = {}, tables = table) => {
    query = `INSERT INTO ${tables} SET ?`;
    return await connectToDB(query, data);
  },
  updateRoles: async (data = {}, whereData = {}, tables = table) => {
  ...
  deleteRoles: async (whereData = {}, tables = table) => {
    const { dataArr, prepStatement } = queryGenerator({ data: whereData });
  ...
  getRole: async (whereData = {}, tables = table) => {
    const { dataArr, prepStatement } = queryGenerator({ data: whereData });
  ...
  getAllRoles: async (whereData = {}, reqQuery = {}, tables = table) => {
    const {
      searchArr,
      date,
      orderArr,
